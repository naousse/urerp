...
public class VenteBean implements Serializable {
    ...
    public void editLigneOperation(ActionEvent actionEvent) {
        ...
        int pos = VenteBean.ligneOperations.indexOf(this.ligneOperation);
    ...
    public void removeLigneOperation(ActionEvent actionEvent) {
        ...
        VenteBean.ligneOperations.remove(this.ligneOperation);
    ...
    public void deleteLigneOperation(ActionEvent actionEvent) {
        ...
        if(this.ligneOperation.getEtat().equals("old")){
         VenteBean.ligneOperationsToDelete.add(this.ligneOperation);
        ...
        VenteBean.ligneOperations = construireListeLigneOperation(ligneOperations, this.ligneOperation);
        this.buttonDisabled = true;

 ...
 * @author samuel
 */
@ManagedBean(name="sellBean2")
@ViewScoped
public class AchatBean2 implements Serializable{
    ...
    public void editLigneOperation(ActionEvent actionEvent) {
        System.out.println("Debut Modification ligne Operation = "+this.ligneOperation.getId());
        
        AchatBean2.ligneOperations.remove(this.ligneOperation);
    ...
    public List<Paiement> getAllPaiementsAchat() {
        System.out.println("Debut recherche");
        return iPaiementEJBMetierLocal.findAllPaiementsOperation(achat);
    }
